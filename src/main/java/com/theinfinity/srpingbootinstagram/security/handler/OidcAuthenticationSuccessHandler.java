...
import static com.theinfinity.srpingbootinstagram.security.cookie.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OidcAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Autowired
    OidcAuthenticationSuccessHandler(JwtService jwtService, AppProperties appProperties,
